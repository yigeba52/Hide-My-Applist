...
public class Constants {
    ...
    public static final String APP_PACKAGE_NAME = "com.tsng.hideapplist";

    public static final String PROVIDER_AUTHORITY = APP_PACKAGE_NAME + "com.tsng.hidemyapplist.ServiceProvider";
